...
!!! info
    ...
    system with OGS, for general information about the OGS OpenProtocol information, see 
...
![Jäger Handling e-Handle](resources/e-handle-Übersicht.png) { width=400px }
